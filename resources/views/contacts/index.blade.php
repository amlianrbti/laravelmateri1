            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <div class="flex justify-between items-center">
                    <form action="" method="get">
                        <input type="text" name="search" class="border border-gray-300 shadow  rounded p-3" placeholder="Cari data kontak..." value="{{ request('search') }}">
                    </form>
                ...
                <table class="table-auto w-full">
                    ...
                    class="bg-yellow-500 text-indigo-700 hover:text-gray-600 p-2">Edit</a>
                    <td class="border p-2"><form action="{{ route('contacts.destroy', $contact) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <input type="submit" value="Delete" class="bg-red-500 text-indigo-700 hover:text-gray-600 p-2"></td>
                </form>
            </td>
        </tr>
                    @endforeach
